...
<body>
    ...
    <section class="hero" >
        ...
        <div class="search-bar" runat="server">
            <asp:TextBox ID="txtSearch1" placeholder="Search for products..." runat="server"></asp:TextBox>
    ...
    <!-- Categories Section -->
    <section class="categories" runat ="server">
       ...
       <!-- <div class="products" runat="server" id="divProducts">
            <!-- Product 1 
